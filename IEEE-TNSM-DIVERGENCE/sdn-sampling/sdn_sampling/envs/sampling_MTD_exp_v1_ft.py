    ...
    def _on_step(self) -> bool:
        if self.n_calls % self.check_freq == 0:
            ...
            if (len(y) == 1e4):
                ...
                plt.show()
                with open('./tmp/results/sampling_MTD_exp_v1_ft_rewards.txt', 'w') as file:
...
# Create log dir
log_dir = "tmp/log/sampling_MTD_exp_v1"
os.makedirs(log_dir, exist_ok=True)

# Create and wrap the environment
env = gym.make('sdnsampling-MTD-exp-v1')
...
model.save("sampling_MTD_exp_v1_ft_1e3")
