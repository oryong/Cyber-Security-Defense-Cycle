...
class SdnSamplingEnv_MTD_v2(gym.Env):
    ...
    def step(self, action):
        ...
        if len(self.result_total) == self.num_steps:
            ...
            with open('./tmp/results/output_MTD_v2_fbc_ft/step_rewards_total.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_total)))

            with open('./tmp/results/output_MTD_v2_fbc_ft/step_rewards_mal_f.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_mal_f)))

            with open('./tmp/results/output_MTD_v2_fbc_ft/step_rewards_v.txt', 'w') as file:
