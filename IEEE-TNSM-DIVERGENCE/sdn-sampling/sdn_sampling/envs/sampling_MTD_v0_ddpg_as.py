    ...
    def _on_step(self) -> bool:
        if self.n_calls % self.check_freq == 0:
            ...
            if (len(y) == 3e4):
                ...
                plt.show()
                with open('./tmp/results/sampling_MTD_v0_ddpg_as_rewards.txt', 'w') as file:
...
# Create log dir
log_dir = "tmp/log/sampling_MTD_as_v0"
os.makedirs(log_dir, exist_ok=True)

# Create and wrap the environment
env = gym.make('sdnsampling-MTD-as-v0')
...
model.save("sampling_MTD_v0_ddpg_as_3e4")
