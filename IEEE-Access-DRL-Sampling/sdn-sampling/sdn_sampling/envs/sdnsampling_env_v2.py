...
class SdnSamplingEnv_v2(gym.Env):
    ...
    def __init__(self):
        ...
        self.num_switches = 100
        self.num_flows = 500000
        self.num_TA = 3
        self.num_samp = 5
        self.total_cap_TA = 3000000.0
        self.r = 0.5
    ...
    def step(self, action):
        ...
        if len(self.result_f) == self.num_steps:
            ...
            with open('./tmp/results/output_FBC_ft/step_rewards_f.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_f)))
            with open('./tmp/results/output_FBC_ft/step_rewards_mal_f.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_mal_f)))
            with open('./tmp/results/output_FBC_ft/step_rewards_u.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_u)))
            with open('./tmp/results/output_FBC_ft/step_rewards_v.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_v)))
            with open('./tmp/results/output_FBC_ft/step_mean_overhead.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_mean_overhead)))
            with open('./tmp/results/output_FBC_ft/step_rewards_total.txt', 'w') as file:
