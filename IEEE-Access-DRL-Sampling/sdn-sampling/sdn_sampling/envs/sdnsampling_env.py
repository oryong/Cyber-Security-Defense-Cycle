...
class SdnSamplingEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if len(self.result_f) == self.num_steps:
            ...
            with open('./tmp/results/output_random_ft/step_rewards_f.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_f)))
            with open('./tmp/results/output_random_ft/step_rewards_mal_f.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_mal_f)))
            with open('./tmp/results/output_random_ft/step_rewards_u.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_u)))
            with open('./tmp/results/output_random_ft/step_rewards_v.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_v)))
            with open('./tmp/results/output_random_ft/step_mean_overhead.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_mean_overhead)))
            with open('./tmp/results/output_random_ft/step_rewards_total.txt', 'w') as file:
