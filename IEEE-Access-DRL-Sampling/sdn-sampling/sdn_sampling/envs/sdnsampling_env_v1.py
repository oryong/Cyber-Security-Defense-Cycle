...
class SdnSamplingEnv_v1(gym.Env):
    metadata = {'render.modes': ['console']}

    def __init__(self):
        # set result var.
        self.routing_candidate = 3
    ...
    def step(self, action):
        ...
        if len(self.result_f) == self.num_steps:
            ...
            with open('./tmp/results/output_ddpg_v1/step_rewards_mv_f.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_f)))
            with open('./tmp/results/output_ddpg_v1/step_rewards_mal_mv_f.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_mal_f)))
            with open('./tmp/results/output_ddpg_v1/step_rewards_mv_u.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_u)))
            with open('./tmp/results/output_ddpg_v1/step_rewards_mv_v.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_v)))
            with open('./tmp/results/output_ddpg_v1/step_mean_overhead_mv.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_mean_overhead)))
            with open('./tmp/results/output_ddpg_v1/step_rewards_total_mv.txt', 'w') as file:
                file.write('\n'.join(map(str, mov_avgs_total)))

            with open('./tmp/results/output_ddpg_v1/step_rewards_f.txt', 'w') as file:
                file.write('\n'.join(map(str, self.result_f)))
            with open('./tmp/results/output_ddpg_v1/step_rewards_mal_f.txt', 'w') as file:
                file.write('\n'.join(map(str, self.result_mal_f)))
            with open('./tmp/results/output_ddpg_v1/step_rewards_u.txt', 'w') as file:
                file.write('\n'.join(map(str, self.result_u)))
            with open('./tmp/results/output_ddpg_v1/step_rewards_v.txt', 'w') as file:
                file.write('\n'.join(map(str, self.result_u)))
            with open('./tmp/results/output_ddpg_v1/step_mean_overhead.txt', 'w') as file:
                file.write('\n'.join(map(str, self.result_mean_overhead)))
            with open('./tmp/results/output_ddpg_v1/step_rewards_total.txt', 'w') as file:
